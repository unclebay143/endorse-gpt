...
const RecommendationTemplate = () => {
  ...
  const templates = [
    ...
    `I had the pleasure of working with ${name} during their time as a ${position} at ${company}. Their dedication to their work and their team was evident in all aspects of their performance. ${name} has a strong work ethic and a unique set of skills that make them stand out in their field. They consistently delivered excellent results, even under tight deadlines. ${name} has an impressive analytical capability, and their enthusiasm for their work is infectious. I would not hesitate to recommend ${name} for any future endeavors.`,
    // `I had the pleasure of working alongside ${name} during their time as a ${position} at ${company}. ${name} has an exceptional work ethic, and their commitment to success is unmatched. They have a unique set of skills that make them a valuable asset to any team, and their ability to lead by example is truly inspiring. ${name} consistently delivered results that exceeded expectations, even under pressure. Their analytical capability and dedication to personal and professional growth make them an ideal candidate for any future opportunities. I highly recommend ${name} for any position they may pursue.`,
