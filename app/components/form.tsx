...
function Form({ handleSubmit }: { handleSubmit: Function }) {
  ...
  return (
    <section className='px-5 py-4 mx-auto my-10 sm:max-w-lg'>
      <section className='flex flex-col items-center justify-center w-full'>
        ...
        >
          ...
          <div className='w-full mb-5'>
            ...
            >
              <div>
                <CounterBadge count='2' className='mb-5' />
              </div>
              <div>
            ...
            <>
              ...
              <div className='w-full mb-5'>
                ...
                >
                  ...
                  <div>
                    Anecdotes of the person's contributions or accomplishments
                    in the workplace{" "}
                    <span className='text-slate-500'>(optional)</span>
                  </div>
                </label>
              ...
              <div className='w-full mb-5'>
                ...
                >
                  ...
                  <div>
                    Why you would recommend this person to others{" "}
                    <span className='text-slate-500'>(optional)</span>
                  </div>
                </label>
                <input
        ...
        <button
          ...
          className='transition mt-5 text-lg text-white bg-black dark:bg-white dark:text-gray-900 font-bold py-2.5 px-2 w-full rounded-md'
        >
          Generate
        </button>
      </section>
